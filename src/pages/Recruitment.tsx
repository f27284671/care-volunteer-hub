...
const allRecruitments = [
  {
    id: 1,
    title: "居家陪伴志工",
    description: "陪伴獨居長者聊天、閱讀、做簡單活動，提供溫暖的社交互動。",
    location: "堀頭里社區",
    ...
    status: "招募中",
    category: "陪伴服務",
    requirements: ["年滿18歲", "具備基本溝通能力", "有耐心與愛心"],
  },
  {
    id: 2,
    title: "日照中心協助志工",
    description: "在社區日照中心協助照顧長者的日常生活起居，包含用餐、活動等。",
    location: "堀頭里日照中心",
    ...
    status: "招募中",
    category: "照顧服務",
    requirements: ["年滿20歲", "具基本照護概念", "可配合時間"],
  },
  {
    id: 3,
    title: "社區活動志工",
    description: "協助舉辦社區長者活動，如節慶聚會、手作課程、健康講座等。",
    location: "堀頭里活動中心",
    time: "週六 09:00-12:00",
    deadline: "2024/03/01",
    spots: 10,
    status: "招募中",
    category: "活動服務",
    requirements: ["年滿16歲", "活潑熱情", "有活動規劃經驗者佳"],
  },
  {
    id: 4,
    title: "電話關懷志工",
    description: "定期電話問候獨居長者，關心其身心健康狀況，提供情緒支持。",
    location: "可在家服務",
    time: "彈性時間",
    deadline: "長期招募",
    spots: 8,
    status: "招募中",
    category: "陪伴服務",
    requirements: ["年滿18歲", "善於傾聽", "有基本電話禮儀"],
  },
  {
    id: 5,
    title: "外出陪同志工",
    ...
    status: "招募中",
    category: "陪伴服務",
    requirements: ["年滿20歲", "具駕照者佳", "細心負責"],
  },
];

const categories = ["全部", "陪伴服務", "照顧服務", "活動服務"];
